          ...
          fortune.setup({
            ...
            custom_quotes = {
              short = {
                ...
                {"My name is Iñigo Montoya, you killed my father, prepare to die!", "- The Princess Bride"},
                {"Get used to disappointment.", "- The Princess Bride"},
                {"You fool! You fell victim to one of the classic blunders!", "- The Princess Bride"},
                {"You are trying to kidnap what I have rightfully stolen, and I think it quite ungentlemanly.", "- The Princess Bride"},
                ...
                {"The maximum of confusion achieved with the maximum of order: it seems a sublime calculation.", "- Umberto Eco"},
                ...
                {"And, for once, he found himself without anything to say.", "- Brandon Sanderson"},
                {"// removing this line breaks everything DONT DO IT", "- Anonymous programmer"},
                {"/** This works as long as the user doesn't input a *. I don't know why and I spent 3 hours trying to figure it out. The below code removes asterisks, because fuck asterisks (temporarily) */ ", "- Anonymous programmer"},
                {"// Redefine my variables again, and I'll murder you and your immediate family", "- Anonymous programmer"},
                {"# we are doomed.  Admit defeat", "- error.py, Reddit's source code"},
                {"There are 10 kinds of people in this world: those who know binary, those who don’t, and those who didn't expect this joke to be in ternary.", "- r/ProgrammerHumor"},
                {"Sometimes my genius is... it's almost frightening", "- Jeremy Clarkson"},
                {"HAMMOOOOOOOOOOOOOOOOOOOND!", "- Jeremy Clarkson"},
                ...
                {"Tired? Try sleeping.", "- Crappy Tips for IRL Loading Screen"},
                {"Money can be exchanged for goods and services.", "- Crappy Tips for IRL Loading Screen"},
                {"The mitochondria is the powerhouse of the cell.", "- Crappy Tips for IRL Loading Screen"},
                {"I'm almost always eventually right.", "- Dr. Gregory House"},
